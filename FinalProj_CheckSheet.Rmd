...
(A) .Rmd Line number(s) for general data wrangling: 76-86, 95-96, 113-114, 136-138


(B) .Rmd Line number(s) for a join operation: 71


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 70


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 67, 76-79, 84-86


(F) .Rmd Line number(s) for use of user-defined functions: 62-63


(G) .Rmd Line number(s) for use of loops and/or control flow: 118-131
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  97, 107

(B) .Rmd Line number(s) for use of multiple aesthetics:  97, 107, 140

(C) .Rmd Line number(s) for use of layered graphics:  107
