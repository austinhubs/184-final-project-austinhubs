...
(A) .Rmd Line numbers where at least two different data sources are imported:  32-34


(B) .Rmd Line numbers for inspecting data intake:  38-55
...
(A) .Rmd Line number(s) for general data wrangling: 66-68, 77, 80-81


(B) .Rmd Line number(s) for a join operation: 78


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 77


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 60-62, 66-68
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  96, 105

(B) .Rmd Line number(s) for use of multiple aesthetics:  83

(C) .Rmd Line number(s) for use of layered graphics:  96, 105
