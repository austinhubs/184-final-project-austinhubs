...
(A) .Rmd Line numbers where at least two different data sources are imported:  35-36


(B) .Rmd Line numbers for inspecting data intake:  40-50
...
(A) .Rmd Line number(s) for general data wrangling: 78-89, 98-100, 117-118, 140-142


(B) .Rmd Line number(s) for a join operation: 72


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 71


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 67, 78-80, 87-89


(F) .Rmd Line number(s) for use of user-defined functions: 62-63


(G) .Rmd Line number(s) for use of loops and/or control flow: 123-135
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  101, 111

(B) .Rmd Line number(s) for use of multiple aesthetics:  101, 11

(C) .Rmd Line number(s) for use of layered graphics:  111
