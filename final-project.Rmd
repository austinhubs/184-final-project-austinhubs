...
FirstLastMonth <- rbind(top,bot) %>% mutate(first = lubridate::dym("2008-03")) %>% mutate(last = lubridate::dym("2015-03")) %>% mutate(DiffDays=last-first) %>% select(RegionName,Size,DiffDays)
FirstLastMonth
